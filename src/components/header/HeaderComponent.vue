...
//   () => route.query,
//   () => {
//     if(route.query.parent_branch && route.query.branch_id){
//       const branch = branches.value.find(e=>e.F_ID == route.query.parent_branch );
//       childBranches.value = branch;
      ...
      <div class="userInfo">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li>
              <a @click="OnLogOut()" class="dropdown-item" href="#">Выход</a>
            </li>
          </ul>
        </div>
      </div>
